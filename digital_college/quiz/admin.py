...
from .models import quiz,multiplechoice,singlechoice,answers,truefalse,respo_single,respo_multiple,respo_true,result,test_given
...
admin.site.register(test_given)